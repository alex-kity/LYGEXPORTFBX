...
namespace UnityEditor.Formats.Fbx.Exporter
{
    ...
    public sealed class ModelExporter : System.IDisposable
    {
        ...
        const string MenuItemNodeName = "GameObject/Export To FBX Node...";
        ...
        private bool ExportInstance(GameObject unityGo, FbxScene fbxScene, FbxNode fbxNode)
        {
            ...
            else if (unityPrefabParent == null)
            {
                ...
                if(unityGoMesh.sharedMesh != null)
                {
 ...
 /// <summary>
        ...
        /// </summary>
        /// <param name="command">Command.</param>
        [MenuItem (MenuItemNodeName, false, 30)]
        static void OnContextItemTest (MenuCommand command)
        {
...

            {
                ...
                if (root != null)
                {
                    ...
                    foreach (Transform childd in root.transform)
                    {
                        //list.Add(childd.gameObject);
                        SetOnExportNode(childd.gameObject, fullPath);
                    }
        ...
        private static void SetOnExportNode (GameObject root,string initialPath)
        {
            GameObject[] selectedGOs = new GameObject[1];
            //GameObject[] selectedGOs = Selection.GetFiltered<GameObject>(SelectionMode.Deep);
            selectedGOs[0] = root;
            ...
            //var filePath = System.IO.Path.Combine(folderPath, filename + ".fbx");
            var filePath = initialPath + "/" + root.name + ".fbx";
            ...
            //filePath = System.IO.Path.Combine(folderPath, root.name + ".fbx");
             filePath = initialPath + "/" + root.name + ".fbx";
            //配置路径
            //Debug.LogError(filePath);
            if (ExportObjects(filePath, toExport.ToArray(), ExportSettings.instance.ExportModelSettings.info) != null)
                {
